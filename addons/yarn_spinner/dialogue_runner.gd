...
## [codeblock]
## dialogue_runner.register_smart_variable("$player_health", func():
...
func register_smart_variable(variable_name: String, evaluator: Callable) -> void:
	if _smart_variable_evaluator == null:
		...
		return
	_smart_variable_evaluator.register_smart_variable(variable_name, evaluator)


func unregister_smart_variable(variable_name: String) -> void:
	if _smart_variable_evaluator == null:
		return
	_smart_variable_evaluator.unregister_smart_variable(variable_name)
