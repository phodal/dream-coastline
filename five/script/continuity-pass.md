...
第三幕的四个藏书选择现在不会卡死，且已能影响第四幕指标、第六幕支持度、关键交互文本和 HUD 目标文案。第四幕续文院和第六幕议会也补了路线专属 visual marker：公开路线读成公共书桌，王族路线读成保管/权力风险，工程路线读成工坊优先，父母路线读成私人资料被公共复核。

### 父母仍以记录和回声为主

父母线目前通过笔记、影像、节点批注、研究摘要、最终记录推进，逻辑成立。第七幕已补 `chose_city_before_parents`：纪子轩回到家后必须先选择救城市，再去实验室追父母线。`parents_record` 和 `bridge` 现在提供半面对面回应：父母要求他先救城市，归桥稳定后只短暂显影，重逢被保留为“路修出来之后继续寻找”。

### 夏离的代价需要截图和演出支持

第五幕已经写了夏离逐渐国书化，并补了 `kept_xiali_private_anchor`：纪子轩用旧讲堂的椅子给夏离留一个私人锚点。`xiali_fading` 和 `bind_xiali` 现在强化了他的语言变化：他会先响应城市节点，再努力把“我们”改回“我”。视觉层已补多节点投影和私人锚点 overlay，并把 `bind_xiali` 改成必须先完成这两个节点。
...
- 第四幕和第六幕 HUD 目标栏会分别显示工程路线专属目标，证明玩家不打开日志也能读到路线差异。

## 下一轮建议

下一轮不要继续泛泛加字数，优先做三个具体补强：

- 分支线：后续可以继续把 route marker 下沉到具体地点资产，但当前已经有 HUD、日志、metrics 和场景 overlay 四层反馈。
- 夏离线：后续可把 overlay 资产化成角色投影动画；当前可玩流程已经不能跳过他的国书化和私人锚点。
- 父母线：后续如果要再推进，应做后日谈式寻找结果，而不是继续在主线结尾塞解释。
