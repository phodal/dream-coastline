...
- Final creative listening is tracked separately in
  `docs/nova-audio-listening-qa.md`, generated by
  `tools/build_audio_listening_checklist.py`. It lists the same 151 generated
  listening assets with per-scene checkboxes and does not count the 198 planned
  or disabled targets as missing audio.
