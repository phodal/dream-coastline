...
func _write_tilesheet() -> void:
	...
	_paint_if_empty(sheet, "academy_floor", Color("#3c3148"), Color("#6a547d"))
...
func _write_ui_skin() -> void:
	...
	image.fill_rect(Rect2i(Vector2i(2, 2), Vector2i(20, 20)), Color("#100c09", 0.96))
	image.fill_rect(Rect2i(Vector2i(0, 3), Vector2i(24, 18)), Color("#8f7040", 0.72))
	image.fill_rect(Rect2i(Vector2i(3, 0), Vector2i(18, 24)), Color("#8f7040", 0.72))
	image.fill_rect(Rect2i(Vector2i(3, 3), Vector2i(18, 18)), Color("#17110d", 0.96))
	image.fill_rect(Rect2i(Vector2i(4, 4), Vector2i(16, 2)), Color("#d7b15e", 0.42))
	image.fill_rect(Rect2i(Vector2i(4, 18), Vector2i(16, 2)), Color("#3f2a18", 0.72))
	image.set_pixel(3, 3, Color("#f0d18a", 0.9))
	image.set_pixel(20, 3, Color("#f0d18a", 0.9))
	image.set_pixel(3, 20, Color("#3f2a18", 0.9))
	image.set_pixel(20, 20, Color("#3f2a18", 0.9))
...
func _paint_boundaries(layer: TileMapLayer, family: String) -> void:
